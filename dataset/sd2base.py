...
if __name__ == '__main__':
    ...
    view_list = ['left', 'right', 'front left', 'front right', 'back left', 'back right', 'front',
                 'back']  # ['side', 'front', 'back', 'overhead']['side rear']#
        ...
        for lr in ['1e-08']:  #, '2e-08', '1.5000000000000002e-08']:  # ['1e-08','5e-08', '8e-08', '1e-07', '5e-07']:
            ...
            for epoch in os.listdir(os.path.join(file, lr)):
                ...
                for index in range(20):
                    ...
                    # visualize image
                    os.makedirs(os.path.join('2dbase', str('hand side  of ' + opt.prompt + ' from the '), str(view), lr,
                                             epoch[:6]), exist_ok=True)
                    plt.imsave(os.path.join('2dbase', str('hand side  of ' + opt.prompt + ' from the '), str(view), lr,
                                            epoch[:6], str(index) + '.png'), imgs[0])
                    # plt.imshow(imgs[0])
                    # plt.show()
